...
sendMessage=‫שלח‬
sendYourFeedback=‫הגש את המשוב שלך‬
...
errorAuthOD=‫שגיאה באימות OneDrive‬
officeMainHeader=‫הוסף תרשימי draw.io למסמך שלך.‬
officeStepsHeader=‫תוסף זה מבצע את הצעדים הבאים:‬
officeStep1=‫מתחבר ל: Microsoft OneDrive, Google Drive או למכשיר שלך.‬
officeStep2=‫בחר תרשים draw.io.‬
officeStep3=‫צרף את התרשים לתוך המסמך.‬
officeAuthPopupInfo=‫אנא השלם את האימות בחלון שנפתח.‬
officeSelDiag=‫בחר תרשים draw.io:‬
files=‫קבצים‬
shared=‫משותף‬
sharepoint=Sharepoint
officeManualUpdateInst=‫הוראות: העתק תרשים draw.io מהמסמך. אז, בתיבה למטה, לחץ קליק ימני ובחר "הדבק" מהתפריט.‬
officeClickToEdit=‫לחץ על הצלמית לתחילת עריכה:‬
pasteDiagram=‫הדבק תרשים draw.io כאן‬
connectOD=‫התחבר ל-OneDrive‬
