...
confAUpdatePageFailed=Pagina di aggiornamento "{1}" non riuscito.
...
confADelDiagLinkOf=Eliminazione del diagramma di "{1}"
...
confAUpdateDgrmCCFailed=Aggiornamento del collegamento al diagramma "{1}" non è riuscito.
...
confAErrFetchPage=Pagina di recupero degli errori "{1}"
...
fetchingRecentFailed=Non è riuscito a recuperare diagrammi recenti
...
cantFetchChckPerms=Impossibile recuperare le informazioni sul diagramma. Si prega di verificare che tu abbia l'autorizzazione di lettura su quel file.
...
select=Seleziona
errCantGetIdType=Errore imprevisto: non è possibile ottenere ID o tipo di contenuto.
...
errSavingTryLater=L'errore si è verificato durante il salvataggio, riprova più tardi.
...
confADeepIndexStarted=L'indicizzazione profonda è iniziata
