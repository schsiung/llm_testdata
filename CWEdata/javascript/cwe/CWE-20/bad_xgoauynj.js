...
allChangesSavedInDrive=Alle ændringer blev gemt i Drev
...
atlas=Atlas
author=Ejer
authorizationRequired=Autorisation påkrævet
authorizeThisAppIn=Tillad denne app i {1}
authorize=Tillad
authorizing=Tillader
...
userJoined={1} deltager nu i chatten
userLeft={1} har forladt chatten
...
enterPropertyName=Indtast egenskabsnavn
...
fileOpenLocation=Hvordan vil du åbne disse fil(er)?
...
formattedText=Formateret tekst
formatPng=PNG
formatGif=GIF
formatJpg=JPEG
formatPdf=PDF
...
includeCopyOfMyDiagram=Medtag en kopi af mit diagram
increaseIndent=Forøg indrykning
decreaseIndent=Reducér indrykning
insert=Indsæt
...
rotate=Roter
rotateTooltip=Klik og træk for at rotere, klik for at rotere 90 grader
rotation=Rotation
rounded=Afrundet
save=Gem
...
sendMessage=Send
sendYourFeedback=Send feedback
...
writingDirection=Tekstretning
yes=Ja
yourEmailAddress=Din email-adresse
zoom=Zoom
zoomIn=Zoom ind
zoomOut=Zoom ud
basic=Grundlæggende
businessprocess=Forretningsprocesser
charts=Diagrammer
engineering=Teknisk
