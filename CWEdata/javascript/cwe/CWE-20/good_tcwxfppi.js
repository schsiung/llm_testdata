...
atlas=Atlas
author=Autor
authorizationRequired=Volitus vajatud
authorizeThisAppIn=Anna sellele rakendusele volitus {1}:
authorize=Volita
authorizing=Volitamine
automatic=Automaatne
autosave=Automaatne salvestus
...
bottom=Alaäär
bottomAlign=Alaääre joondamine
...
download=Lae alla
downloadDesktop=Lae töölaua programmina
...
dragImagesHere=Pukseeri pildid või URLid siia
dragUrlsHere=Pukseeri URLid siia
draw.io=draw.io
drawing=Joonis{1}
...
layout=Asetus
left=Vasak
leftAlign=Vasakule joondatud
leftToRight=Vasakult paremale
libraryTooltip=Lohista ja kukuta kujundid siia või kliki + lisa. Topeltklõps toimetamiseks.
lightbox=Valguskast
line=Rida
lineend=Rea lõpp
...
moreShapes=Rohkem kujundeid
move=Liiguta
moveToFolder=Liiguta kausta
moving=Liigutamine
...
noPlugins=Pluginaid pole
noPreview=Puudub eelvaade
noResponse=Server ei vasta
noResultsFor=Puuduvad vastused '{1}'-le
noRevisions=Ilma toimetatud versioonideta
noSearchResults=Otsingutulemusi ei leitud
noPageContentOrNotSaved=Ankruid ei leitud sellelt lehelt või seda pole veel salvestatud
normal=Normaalne
north=Põhi
...
pageWithNumber=Leht-{1}
pages=Lehed
pageView=Lehevaade
pageSetup=Lehe parameetrid
pageScale=Lehe skaala
pan=Panoraam
panTooltip=Tühik+Lohista liigutamiseks
...
plantUml=PlantUML
plugins=Pluginad
pluginUrl=Plugini URL
pluginWarning=Leht on palunud järgneva(te) plugini/pluginate laadimist:\n \n {1}\n \n Kas soovid seda/neid pluginit/pluginaid laadida kohe?\n \n TÄHELEPANU: Luba pluginate jooksutamist ainult juhul, kui mõistad täielikult sellega kaasnevaid turvariske.\n
plusTooltip=Kliki, et ühendada ja kloonida (ctrl+klikk kloonimiseks, shift+klikk ühendamiseks). Lohista ühendamiseks (ctrl+lohista kloonimiseks).
portrait=Portree
position=Positsioon
posterPrint=Postritrükk
preferences=Eelistused
preview=Eelvaade
previousPage=Eelmine leht
print=Prindi
printAllPages=Prindi kõik lehed
procEng=Proc. Eng.
project=Projekt
priority=Prioriteet
properties=Omadused
...
retryingIn=Proovin uuesti {1} sekundi pärast
retryingLoad=Laadimine ebaõnnestus. Proovin uuesti...
retryingLogin=Logimine võttis liiga kaua aega. Proovin uuesti...
reverse=Pööra ümber
...
rotate=Keera
rotateTooltip=Kliki ja lohista keeramiseks, kliki 90-kraadiseks keeramiseks
rotation=Keeramine
rounded=Ümmargune
save=Salvesta
...
sessionExpired=Sinu sessioon on aegunud. Palun värskenda brauseriakent.
sessionTimeoutOnSave=Sinu sessioon on aegunud ja sind on Google Drive'st lahti ühendatud. Vajuta OK sisse logimiseks ja salvestamiseks.
setAsDefaultStyle=Sea vaikestiiliks
shadow=Vari
shape=Kujund
shapes=Kujundid
share=Jaga
...
templates=Mallid
text=Tekst
textAlignment=Teksti joondus
textOpacity=Teksti läbipaistvus
theme=Teema
timeout=Ajalimiit
title=Pealkiri
to=kuni
...
warning=Hoiatus
waypoints=Kontrollpunktid
west=Lääs
width=Laius
wiki=Wiki
wordWrap=Sõnade mähkimine
writingDirection=Kirjutamise suund
yes=Jah
yourEmailAddress=Sinu e-posti aadress
zoom=Suurenda
zoomIn=Suurenda sisse
zoomOut=Suurenda välja
basic=Elementaarne
businessprocess=Äriprotsessid
charts=Graafikud
engineering=Inseneeria
flowcharts=Voogdiagrammid
gmdl=Materjalidisain
mindmaps=Mõttekaardid
mockups=Mallid
networkdiagrams=Võrgustikudiagrammid
nothingIsSelected=Midagi pole valitud
other=Muu
softwaredesign=Tarkvaradisain
venndiagrams=Venni diagrammid
